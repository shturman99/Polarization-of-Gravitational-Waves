...
The two branches can be exhibited directly rather than inferred. We evaluate the
...
\begin{enumerate}\itemsep2pt
  ...
  (Sec.~\ref{sec:principal-discrepancy}). What remains genuinely open is whether
