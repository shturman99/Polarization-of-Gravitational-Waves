...
\rev{This straddle is manufactured by the wrong coefficient. With $2.33/T_{\rm em}=0.058$
the struck sentence (``the band lies above the window break'') was correct. Revert once the
blocking comment is resolved.}
