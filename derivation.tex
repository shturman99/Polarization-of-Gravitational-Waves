...
\ifreviewmarkup
  ...
  \newcommand{\why}[1]{\textcolor{red}{\footnotesize\textsf{[#1]}}}
\else
  \newcommand{\add}[1]{#1}
  \newcommand{\del}[1]{}
  \newcommand{\why}[1]{}
...
the $p\simeq2.4$ of the decaying kernel, while the sweeping law $1.47M$ falls
...
\begin{figure}[ht]
  ...
  $p\simeq2.4$ (dotted) and the stationary sweeping law $1.47M=1.47\sqrt{2\pi}/
...
$2.57\times10^{-4}$, i.e.\ the $1.47M$ sweeping scaling) and the Batchelor-only
...
$1.47\,M$ of Eq.~\eqref{eq:peak-fit} recovered from that band alone, and at a
...
\begin{figure}[ht]
  ...
  \emph{(c)}~Peak position against $M$, with the $1.47\,M$ sweeping law of
...
\begin{table*}[ht]
  ...
  Chiral plasma instability \cite{Joyce:1997uy,Brandenburg:1996fc} &
    ...
    The one genuinely stationary case; sweeping peak $1.47M$ \\
...
\begin{table*}[ht]
  ...
  \hline
  $H[S_{\rm K41},T_{\rm sw}]$   & $3.00$ & $1.47M$ & super-exp & yes & Gogoberidze et al.~\cite{Gogoberidze:2007an} \\
