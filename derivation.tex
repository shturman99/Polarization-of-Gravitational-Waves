...
consequences drawn from it in this paragraph, are our interpretation; \cite{2019RoperPol}
...
record for \cite{2019RoperPol} notes a corrected normalisation error), and the analytic
...
\begin{table}[ht]
  ...
  \begin{tabular}{l r r r r}
    ...
    \hline\hline
  \end{tabular}
  \caption{Logarithmic slopes $n[X]=d\ln X/d\ln k$ compiled by \cite{2019RoperPol}: the two
...
\cite{2019RoperPol} themselves give---the spectrum of $B^2$ ``can never be steeper than that
...
\begin{table*}[ht]
  ...
  \begin{tabular}{l l l l l}
    ...
    \hline
    Gogoberidze 2007 \cite{2007Gogoberidze} & Gaussian, $\eta_k\propto k^{2/3}$  & $\sim M k_0$  & $k^3$ & steep ($\sim k^{-9/2}$) \\
...
\cite{2020CaiPiSasaki} must accordingly be imported analytically and never expected from a
...
published run parameters; it is not stated in \cite{2019RoperPol}.)
...
\begin{figure}[ht]
  ...
  $p^3$. All three are causal to better than $2\%$ in the exponent, including the
  ...
  two modes with $k<k_0$. Parameters: $M=0.5$, $R=(k_d/k_0)^{4/3}=10^4$,
