...
simulation of the GW signal uses the correct one---an omission acknowledged in the
field's own review of the relevant magnetohydrodynamics \cite{RoperPol:2025lgc}. We
identify that gap and set out how to close it, but do not close it here.
\end{abstract}
...
\begin{enumerate}\itemsep2pt
  ...
  (Sec.~\ref{sec:outlook}). The omission is acknowledged in the field's own review
  of the relevant magnetohydrodynamics \cite{RoperPol:2025lgc}. We identify the gap
