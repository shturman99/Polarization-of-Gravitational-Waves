...
What it does not test is equally worth stating. The band lies above the window break but
...
First, \emph{the causal $+3$ is not in the box}: the infinitely coherent control, which
...
\begin{table}[ht]
  ...
  three decimals against $R$ over $36$--$376$ and $R_{\rm IR}$ over $5.2$--$100$.
